...
export async function buildMonthlyReportData(targetMonth) {
  ...
  // A client in the roster only makes it into the report if at least one of
  // its platform mappings is currently live — not just present in Supabase.
  // A budget alone, with nothing connected, isn't enough to appear.
